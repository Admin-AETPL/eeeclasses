        ...
        <div class="row">
            <div class="col-12 col-sm-6 p-5 d-none d-sm-block" style="position:relative">
                <div class="login-form p-5" style="position: absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:75%">
                    <h3 class="h3 text-white text-center">Student Login</h3>
                    <form action="<?php echo $home ?>student_users/login" class="" method="POST">
                        <div class="form-group my-2">
                            <input type="text" class="form-control uid" id="uid" name="uid" placeholder="Enter Student ID" required>
                        </div>
                        <div class="form-group my-2">
            ...
            <div class="col-12 col-sm-6 p-5 d-block d-sm-none">
                <div class="login-form p-5 bg-light" style="position: absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:75%">
                    <h3 class="h3 text-center" style="color:#2a3162">Student Login</h3>
                    <br>
                    <form action="<?php echo $home ?>student_users/login" class="" method="POST">
                        <div class="form-group my-2">
                            <input type="text" class="form-control uid border-bottom border-dark border-1 text-dark" id="uid1" name="uid" placeholder="Enter Student ID" required>
                        </div>
                        <div class="form-group my-2">
