        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-lg-6 order-2 order-lg-1 order-sm-1 py-4">
                <section class="header">
                    <h3 class="h3 text-start text-dark">EEE Class 12 - Mathematics</h3>
            ...
            <div class="col-12 col-sm-12 col-lg-6 order-1 order-lg-2 order-sm-2 text-center">
                <img src="<?php echo $home ?>img/background/class-12-maths.jpg" alt="" class="img-fluid imganim" style="height: 350px;">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-12 col-sm-12">
                <div class="text-start">
                    <h4 class="h4 text-dark text-start fw-bold">Mathematics</h4>
                    <p class="text-dark">Mathematics includes the study of such topics as numbers (arithmetic and number theory),
                        formulas and related structures (algebra), shapes and spaces in which they are contained (geometry),
                        and quantities and their changes (calculus and analysis).
                        Mathematics is widely used in science for modeling phenomena. This enables the extraction of quantitative predictions from experimental laws. For example, the movement of planets can be predicted with high accuracy using Newton's law of gravitation combined with mathematical computation.
                    </p>
                </div>
            </div>
            <div class="col-12 col-sm-12">
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <div class="text-start">
                                    <h5 class="h5 text-dark text-start fw-bold">Chapter-1: Relations and Functions </h5>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <div class="text-start">
                                    <h5 class="h5 text-dark text-start fw-bold">Chapter-1: Matrices</h5>
                                    <p class="text-dark">Concept, notation, order, equality, types of matrices, zero and identity matrix, transpose of a matrix,
                                ...
                                <div class="text-start">
                                    ...
                                    <p class="text-dark">Determinant of a square matrix (up to 3 x 3 matrices), minors, co-factors and applications of
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <div class="text-start">
                                    <h5 class="h5 text-dark text-start fw-bold">Chapter-1: Continuity and Differentiability </h5>
                                    <p class="text-dark">Continuity and differentiability, derivative of composite functions, chain rule, derivative of inverse
                                ...
                                <div class="text-start">
                                    ...
                                    <p class="text-dark">Applications of derivatives: increasing/decreasing functions, tangents and normals, maxima and
