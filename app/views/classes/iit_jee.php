<div class="class11 pt-2" style="background:#8cc540">
    <h3 class="h2 text-white text-center">Want to crack IIT-JEE?</h2>
    <img src="<?php echo $home ?>img/background/iitjeebg.jpg" alt="" class="img-fluid w-100">
</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-6 col-sm-4 my-1">
                    ...
                    <div class="text-center bg-white pb-2 subj rounded" onclick="alert('Please contact admin for further details')">
                        <img src="<?php echo $home ?>img/background/iit-maths.jpg" alt="" class="rounded-top img-fluid">
                        <h4 class="h4 text-dark text-center">Maths</h4>
                        <button type="button" class="btn btn-primary">View</button>
                    </div>
