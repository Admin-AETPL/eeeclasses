        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-lg-6 order-2 order-lg-1 order-sm-1 py-4">
                <section class="header">
                    <h3 class="h3 text-start text-dark">EEE Class 11 - Biology</h3>
            ...
            <div class="col-12 col-sm-12 col-lg-6 order-1 order-lg-2 order-sm-2 text-center">
                <img src="<?php echo $home ?>img/background/class-12-biology.jpg" alt="" class="img-fluid imganim" style="height: 350px;">
            </div>
        </div>
    </div>
</div>
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                ...
                                <div class="text-start">
                                    ...
                                    <p class="text-dark">Salient features and classification of animals, non-chordates up to phyla level and chordates up
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">
                                <div class="text-start">
                                    <h5 class="h5 text-dark text-start fw-bold">Chapter-8: Cell-The Unit of Life </h5>
                                    <p class="text-dark">Cell theory and cell as the basic unit of life, structure of prokaryotic and eukaryotic cells; Plant
