<div class="bg-white py-3">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-sm-6">
                <img src="<?php echo $home ?>img/background/comp-exams.png" alt="" class="img-fluid">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="row bg-light rounded-3">
            ...
            <div class="col-12 col-sm-12 col-md-6 py-4 order-1 order-sm-1 order-md-2">
                <div class="text-center">
                <a href="<?php echo $home ?>course/ntse"><img src="<?php echo $home ?>img/logo/ncert-logo.png" alt="" style="height:350px" class="img-fluid"></a>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row rounded-3" style="background: url('<?php echo $home ?>img/background/science.jpg') center no-repeat;background-size:cover">
            <div class="col-12 col-sm-12 pt-4 pb-2 text-center">
                <a href="<?php echo $home ?>course/kvpy"><img src="<?php echo $home ?>img/background/kvpy-logo.png" alt="" class="img-fluid"></a>
            </div>
            <div class="col-12 col-sm-12">
